...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.cobra.upapp2.R.layout.activity_main2);

        listMini = findViewById(com.example.cobra.upapp2.R.id.listView);
        btnUp = findViewById(com.example.cobra.upapp2.R.id.btnUpload);
        btnDown = findViewById(com.example.cobra.upapp2.R.id.btnDownload);
